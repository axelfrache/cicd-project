...
class ApiTests(@Autowired val mockMvc: MockMvc) {
    ...
    fun testGetAllCities() {
        every { cityRepository.findAll() } returns listOf(
    ...
    @Test
    fun testPostCity() {
        every { cityRepository.save(any()) } returns City(id = 1, departmentCode = "31", inseeCode = "feur", zipCode = "31790", name = "Saint-Sauveur", lat = 45.610769, lon = 2.876716)
